...
const AdminDashboard = () => {
    ...
    const createUser = async () => {
        try {
            ...
            setErrors(prev => ({ ...prev, users: error.response?.data?.message || "Failed to create user" }));
        } finally {
            ...
            Admin Panel
                    ...
                    {activeTab === "users" && (
                        ...
                        <div className="controls-row">
                            ...
                            >
                              <i style={{color:'white'}} className="fas fa-user mr-2"></i>
                              Bulk Import Users
                            </button>
                            ...
                            />
                                ...
                                >
                              <i style={{color:'white'}} className="fas fa-plus mr-2"></i>
                                    Add User
                                </button>
                                            ...
                                            <tr key={user.id}>
                                                ...
                                                <td>
                                                    {!user.is_approved && (
                                                        ...
                                                        >
                                                          <i style={{color:'white'}} className="fas fa-check mr-2"></i>
                                                            Approve
                                                        </button>
                                                    )}
                                                </td>
                    ...
                    <div className="classic-modal-container">
                        ...
                        <div className="classic-modal-footer">
                            ...
                            <button 
                                ...
                                onClick={createUser}
                                disabled={loading.actions || !modalData.user.username || !modalData.user.email || !modalData.user.role}
                            >
                                {loading.actions ? (
                                    <>
                ...
                <div className="classic-modal-overlay active">
                    <div className="classic-modal-container classic-modal-sm">
                        ...
                        <div className="classic-modal-footer">
                            ...
                            <button 
                                className="classic-modal-btn classic-modal-btn-success" 
                                onClick={approveUser}
                                disabled={loading.actions}
                            >
                                {loading.actions ? (
