...
const SubmitPrototypeModal = ({ show, onHide, onPrototypeSubmitted }) => {
  ...
  return (
    <Modal show={show} onHide={onHide} centered  >
     <div style={{width:'600px' , marginLeft:'1rem', backgroundColor:'white' , alignItems:'center' , justifyContent:'center'}}>
     <Modal.Header closeButton>
      ...
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{color:'#64A293'}}>Report (PDF, DOC, DOCX)</Form.Label>
            <Form.Control
              type="file"
              accept=".pdf,.doc,.docx"
          ...
          <Form.Group className="mb-3">
            <Form.Label style={{color:'#64A293'}}>Source Code (ZIP, RAR)</Form.Label>
            <Form.Control
              type="file"
              accept=".zip,.rar"
          ...
          <Button variant="primary" style={{backgroundColor:'#64A293' , padding:'12px' , border:'none', borderRadius:'10px'}} type="submit" disabled={loading}>
...
const SubmitPrototype = () => {
  ...
  return (
    <div>
      <Button variant="success" style={{backgroundColor:'#64A293' , padding:'12px' , border:'none', borderRadius:'10px'}}  onClick={handleShowModal}>
        ADD PROTOTYPE
      </Button>
